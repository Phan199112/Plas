...
class CategoryListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.registerNib(UINib(nibName: "CategoryListTableViewCell", bundle: nil), forCellReuseIdentifier: "categorylistCell")
        self.loadData()
    ...
    func loadData() {
        ...
        request.url = ApiUrl.GET_CATEGORIES
