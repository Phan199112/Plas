...
#define HUD_SPINNER_COLOR		[UIColor colorWithRed:12.0/255.0 green:240.0/255.0 blue:216.0/255.0 alpha:1.0]
...
#define HUD_IMAGE_SUCCESS		[UIImage imageNamed:@"valid_button"]
#define HUD_IMAGE_ERROR			[UIImage imageNamed:@"close_button"]
