...
class DPSegmentedControl:UIControl {
    ...
    private var componentOrientation: ComponentOrientation = ComponentOrientation.TopDown
    ...
    private func setTextColor(){
        for i in 0..<labels.count {
            ...
            labels[i].font = AppFont.OpenSans_12
    ...
    private func getIconFrameByOrientation(orientation:ComponentOrientation, index:Int, text:String) -> CGRect {
        ...
        case .LeftRight:
            ...
            return iconRect
        case .TopDown:
            let centre:CGFloat = x + ((width-20)/2)
            let iconRect = CGRectMake(centre, 14, 20, 20)
            return iconRect
        }
    }
    ...
    private func getTextFrameByOrintation(orientation:ComponentOrientation, text:String, index:Int) -> CGRect {
        ...
        case .LeftRight:
            ...
            return textRect
        case .TopDown:
            let centre = xPosition
            let textRect:CGRect?
            if withIcon {
                textRect = CGRectMake(centre, 40, width, 25)
            }else {
